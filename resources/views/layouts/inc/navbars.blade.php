<div class="container-fluid">
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 sidenav mb-3">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li class="nav-item">
                        <div class="dropend">
                            <i class="fs-4 bi-grid p-1 {{ Request::is('rendelesek') ? 'active' : '' }}"></i>
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item">
                                    <a href="{{ url('rendelesek') }}" class="px-0 align-middle">
                                        </i><span class="ms-1 d-none d-sm-inline ms-3">Iphone</span></a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('rendelesek') }}" class="px-0 align-middle">
                                        </i><span class="ms-1 d-none d-sm-inline ms-3">iPad</span></a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('rendelesek') }}" class="px-0 align-middle">
                                        </i><span class="ms-1 d-none d-sm-inline ms-3">MacBook</span></a>
                                </li>
                            </ul>
                          </div>
                    </li>
